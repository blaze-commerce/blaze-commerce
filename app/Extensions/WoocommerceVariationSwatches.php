...
class WoocommerceVariationSwatches {
	...
	/**
	 * Cache for term_order column existence check
	 *
	 * @var bool|null
	 */
	private static $term_order_column_exists = null;
	...
	/**
	 * Check if term_order column exists in term_taxonomy table
	 * This check is cached for performance optimization
	 *
	 * @return bool True if term_order column exists, false otherwise
	 */
	private function has_term_order_column() {
		if ( self::$term_order_column_exists !== null ) {
			return self::$term_order_column_exists;
		}
		...
		self::$term_order_column_exists = (bool) $column_exists;
	...
	public function try_positional_swatch_type_matching( $term, $swatch_options, $product_id ) {
		...
		// Check if term_order column exists and build query accordingly
		$has_term_order = $this->has_term_order_column();
